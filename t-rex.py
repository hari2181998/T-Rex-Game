...
while capture.isOpened():
    ...
    mask2 = cv2.inRange(hsv, np.array([2,20,192]), np.array([179,62,221]))
    ...
    filtered = cv2.GaussianBlur(erosion, (3,3), 2)
    ret,thresh = cv2.threshold(filtered, 95, 255, 0, cv2.THRESH_BINARY)
